    ...
    protected function dummyDataFor(string $key, bool $includeTag = true): array
    {
        $data = match ($key) {
            ...
            'disposisi_personil' => [
                ...
                'sapaan' => 'Bapak/Ibu Budi',
                'nama' => 'Budi',
                'kegiatan' => 'Rapat Koordinasi Lintas Bidang',
                'tanggal' => 'Selasa, 13 Januari 2026',
                'tempat' => 'Ruang Rapat Utama',
                'keterangan_raw' => 'Mohon hadir tepat waktu dan membawa bahan paparan terbaru.',
                'batas_tl' => 'Rabu, 14 Januari 2026 10:00 WIB',
                'surat_url' => 'https://example.com/surat',
                'kegiatan_line' => "*Kegiatan:* Rapat Koordinasi Lintas Bidang\n",
                'tanggal_line' => "*Hari/tanggal:* Selasa, 13 Januari 2026\n",
                'tempat_line' => "*Tempat:* Ruang Rapat Utama\n",
                'keterangan_line' => "*Keterangan:*\nMohon hadir tepat waktu dan membawa bahan paparan terbaru.\n",
                'batas_tl_line' => "*Batas TL:* Rabu, 14 Januari 2026 10:00 WIB\n",
