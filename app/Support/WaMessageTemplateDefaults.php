...
class WaMessageTemplateDefaults
{
    ...
    public static function definitions(): array
    {
        ...
        $definitions = [
            ...
            'disposisi_personil' => [
                'label' => 'Notifikasi Disposisi (Personil)',
                'description' => 'Notifikasi disposisi agenda ke personil penerima.',
                'placeholders' => [
                    'greeting',
                    'sapaan',
                    'nama',
                ...
                'sections' => [
                    'header' => [
                        'label' => 'Pembuka',
                        'template' => '{greeting} {sapaan} telah mendapatkan disposisi agenda sebagai berikut:',
                    ],
                    'body' => [
                        'label' => 'Isi Disposisi',
